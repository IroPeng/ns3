...
public:
  ...
  typedef Callback< bool, Ptr<UanNetDevice>, Ptr<const Packet>, uint16_t, const UanAddress & > ForwardL3Callback;

  void SetForwardL3Callback (ForwardL3Callback cb);
...
private:
  ...
  //Added to adpat in routing
  ForwardL3Callback m_forwardL3Cb;//callback connect to l3 protocol receive
